...
Middleware corsMiddleware({
  ...
  final normalizedOrigins =
      allowedOrigins.map((o) => o.trim()).where((o) => o.isNotEmpty).toSet();
  ...
  return (Handler inner) {
    return (Request request) async {
      ...
      final isAllowed = !hasOrigin ||
          normalizedOrigins.isEmpty ||
          allowsAnyOrigin ||
          normalizedOrigins.contains(origin);
